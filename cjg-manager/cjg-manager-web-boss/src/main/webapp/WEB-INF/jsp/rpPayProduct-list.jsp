...
<script>
    ...
    $('#rg').datagrid({
        ...
        columns:[[
            ...
            {field:'payWayCode',title:'操作',width:100 ,formatter: function(value,row,index){

              var id = row.productCode;
              var url = "${pageContext.request.contextPath}/selectRpPayWays?id="+id;
                return '<a style="color:blue" href="'+url+'" >查看支付方式</a>'
            }}
